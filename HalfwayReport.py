...
class GameSpace(object):
    ...
    def get_rent_amount(self):
        """
        returns _space_amount that must be paid when non-owner player lands
        on space or the _space_amount paid to player when passing GO
        """
...
class RealEstateGame(object):
    ...
    # create_spaces - takes two parameters: the _space_amount of money given to players when they
    ...
    # move_player - takes as parameters the name of the player, and the number of spaces to move
        ...
        #   if necessary
            ...
            # Otherwise:
                ...
                # The player will not pay more than the _space_amount in player's account balance
                # The _space_amount paid is deducted from the players account and deposited into the game space owner's account
